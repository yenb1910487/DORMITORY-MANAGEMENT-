<?php
    ...
    if(isset($_SESSION['admin'])){
        if(isset($_GET['giatri'])){
           ...
           $sql ="SELECT * FROM suachua_csvc,kytucxa, sinhvien_da_o,sinhvien_chua_o where sinhvien_chua_o.id=sinhvien_da_o.idsv and kytucxa.id = suachua_csvc.idktx and sinhvien_da_o.id = suachua_csvc.idsv and toanha like '%$giatri%'";
