<?php
    ...
    if(isset($_SESSION['admin'])){
        if(isset($_GET['giatri'])){
            ...
            $sql ="SELECT * FROM `sinhvien_da_o`,sinhvien_chua_o,kytucxa where sinhvien_da_o.idsv = sinhvien_chua_o.id and sinhvien_da_o.idktx = kytucxa.id and (mssv like '%$giatri%' or hoten like '%$giatri%') order by toanha,phong asc ";
